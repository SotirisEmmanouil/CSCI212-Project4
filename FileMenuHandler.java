...
public class FileMenuHandler implements ActionListener{
 ...
 public FileMenuHandler (DateGUI jf) {
  ...
  public void actionPerformed(ActionEvent event) {		//method which how the
	      String menuName = event.getActionCommand();		//file menu reacts when 
   ...
   public static void printLists(String[] list) {			//append the unsorted array to the GUI
	  ...
	  private void openFile() {					//method to open file
	       ...
	       if (status == JFileChooser.APPROVE_OPTION) 
	          ...
	          JOptionPane.showMessageDialog(null, "File retrieval cancelled"); //if you click on cancel when searching for a file, this messages will appear.
	  }	  
}
